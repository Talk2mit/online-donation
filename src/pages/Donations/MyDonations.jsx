            ...
            <div className="relative md:flex w-full  flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                ...
                <div style={{ backgroundColor: card_bg }} className="relative m-0 md:w-3/5 p-4">
                    <div className="py-4 px-2">
                        ...
                        <h3 style={{ color: text_btn_color }} className="text-lg font-semibold py-2 mb-3">${price.toFixed(2)}</h3>
                        <button style={{ backgroundColor: text_btn_color }} className="text-white font-medium text-sm mb-2 px-5 py-2 rounded-md">View Details</button>
                    </div>
                </div>
            </div>
        </div>
